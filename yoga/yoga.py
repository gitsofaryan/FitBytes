...
st.set_page_config(page_title='Yoga Sphere', page_icon="🖖")
...
#                 print(landmarks)
                ...
                for i, data_point in zip(range(len(landmarks)), landmarks):
                    ...
                    joint_list = pd.concat(
                        [joint_list, joints], axis=0, ignore_index=True)
...
#                 cv2.putText(image, 'why so tiny?',(1935, 1758), cv2.FONT_HERSHEY_SIMPLEX, 1, [0,0,255], 2, cv2.LINE_AA )
                cv2.putText(image, str(1), tuple(np.multiply(right_elbow, [image_w, image_h,]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 1, [0, 153, 76], 2, cv2.LINE_AA)
                cv2.putText(image, str(2), tuple(np.multiply(left_elbow, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 1, [0, 153, 76], 2, cv2.LINE_AA)
                cv2.putText(image, str(3), tuple(np.multiply(right_shoulder, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, [0, 153, 76], 1, cv2.LINE_AA)
                cv2.putText(image, str(4), tuple(np.multiply(left_shoulder, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, [0, 153, 76], 1, cv2.LINE_AA)
                cv2.putText(image, str(5), tuple(np.multiply(right_hip, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, [0, 153, 76], 1, cv2.LINE_AA)
                cv2.putText(image, str(6), tuple(np.multiply(left_hip, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, [0, 153, 76], 1, cv2.LINE_AA)
                cv2.putText(image, str(7), tuple(np.multiply(right_knee, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, [0, 153, 76], 1, cv2.LINE_AA)
                cv2.putText(image, str(8), tuple(np.multiply(left_knee, [image_w, image_h]).astype(
                    int)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, [0, 153, 76], 1, cv2.LINE_AA)
            except:
                pass
            ...
            mp_drawing.draw_landmarks(image, results.pose_landmarks, mp_pose.POSE_CONNECTIONS,
                                      mp_drawing.DrawingSpec(
                                          color=(50, 168, 158), thickness=3, circle_radius=2),
...
#             cv2.rectangle(image, (0,0), (   int(image_w - (image_w*0.8)), int(image_h - (image_h*0.75))   ), (255,255,255), -1)
            ...
            cv2.putText(image, 'ID', (10, 14), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        50, 168, 113], 2, cv2.LINE_AA)
            cv2.putText(image, str(1), (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            ...
            cv2.putText(image, 'Angle', (40, 12), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        50, 168, 113], 2, cv2.LINE_AA)
            ...
            cv2.putText(image, str(int(angle2)), (40, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            cv2.putText(image, str(int(angle3)), (40, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            cv2.putText(image, str(int(angle4)), (40, 130), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            cv2.putText(image, str(int(angle5)), (40, 160), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            cv2.putText(image, str(int(angle6)), (40, 190), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            cv2.putText(image, str(int(angle7)), (40, 220), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
            cv2.putText(image, str(int(angle8)), (40, 250), cv2.FONT_HERSHEY_SIMPLEX, 0.7, [
                        153, 153, 0], 2, cv2.LINE_AA)
...
#     cv2.rectangle(image,(0,40), (370,370), (0,0,0), -1)
    ...
    if angle_user[0] < (angle_target[0] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Extend the right arm at elbow"), (10, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[0][0]*width), int(angle_point[0][1]*height)), 30, (0, 0, 255), 5)

    if angle_user[0] > (angle_target[0] + 15):
        #print("Fold the right arm at elbow")
        stage = stage + 1
        cv2.putText(image, str("Fold the right arm at elbow"), (10, 80),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[0][0]*width), int(angle_point[0][1]*height)), 30, (0, 0, 255), 5)
    ...
    if angle_user[1] < (angle_target[1] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Extend the left arm at elbow"), (10, 100),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[1][0]*width), int(angle_point[1][1]*height)), 30, (0, 0, 255), 5)

    if angle_user[1] > (angle_target[1] + 15):
        #print("Fold the left arm at elbow")
        stage = stage + 1
        cv2.putText(image, str("Fold the left arm at elbow"), (10, 120),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[1][0]*width), int(angle_point[1][1]*height)), 30, (0, 0, 255), 5)
    ...
    if angle_user[2] < (angle_target[2] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Lift your right arm"), (10, 140),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
    ...
    if angle_user[3] < (angle_target[3] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Lift your left arm"), (10, 180),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[3][0]*width), int(angle_point[3][1]*height)), 30, (0, 0, 255), 5)

    if angle_user[3] > (angle_target[3] + 15):
        #print("Put your arm down a little")
        stage = stage + 1
        cv2.putText(image, str("Put your arm down a little"), (10, 200),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[3][0]*width), int(angle_point[3][1]*height)), 30, (0, 0, 255), 5)
    ...
    if angle_user[4] < (angle_target[4] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Extend the angle at right hip"), (10, 220),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
    ...
    if angle_user[4] > (angle_target[4] + 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Reduce the angle of at right hip"), (10, 240),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[4][0]*width), int(angle_point[4][1]*height)), 30, (0, 0, 255), 5)
    ...
    if angle_user[5] < (angle_target[5] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Extend the angle at left hip"), (10, 260),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
    ...
    if angle_user[5] > (angle_target[5] + 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Reduce the angle at left hip"), (10, 280),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[5][0]*width), int(angle_point[5][1]*height)), 30, (0, 0, 255), 5)
    ...
    if angle_user[6] < (angle_target[6] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Extend the angle of right knee"), (10, 300),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
    ...
    if angle_user[6] > (angle_target[6] + 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Reduce the angle at right knee"), (10, 320),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[6][0]*width), int(angle_point[6][1]*height)), 30, (0, 0, 255), 5)
    ...
    if angle_user[7] < (angle_target[7] - 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Extend the angle at left knee"), (10, 340),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
    ...
    if angle_user[7] > (angle_target[7] + 15):
        ...
        stage = stage + 1
        cv2.putText(image, str("Reduce the angle at left knee"), (10, 360),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, [0, 153, 0], 2, cv2.LINE_AA)
        cv2.circle(image, (int(
            angle_point[7][0]*width), int(angle_point[7][1]*height)), 30, (0, 0, 255), 5)
...
#     resized = cv2.resize(x[3], (0,0), fx=0.5, fy=0.5, interpolation = cv2.INTER_AREA)
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        ...
        while cap.isOpened():
            ...
            image = cv2.resize(
                image, (int(image_width * (760 / image_height)), 800))
            ...
            if (kb.is_pressed("right")):
                ...
                if current_pose <= 10:
                    ...
                    dim = (560, 800)
                    resized = cv2.resize(
                        x[3], dim, interpolation=cv2.INTER_AREA)
                    cv2.imshow('target', resized)
                    angle_target = x[2]
                    point_target = x[1]
...
def main_loop():
    ...
    def add_bg_from_url():
        st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://wallpaperaccess.com/full/1642650.jpg");
    ...
    st.sidebar.text(
        "-> To change pose click on left/right buttons of the keyboard")
    st.sidebar.text(
        "-> Score will get displayed on the screen with instructions")
